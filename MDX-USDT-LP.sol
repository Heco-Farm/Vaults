...
contract StratX is Ownable, ReentrancyGuard, Pausable {
    ...
    address public hecoFarmAddress;
    ...
    constructor(
        ...
        hecoFarmAddress = _hecoFarmAddress;
        ...
        transferOwnership(hecoFarmAddress);
    }
        ...
        returns (uint256)
    {
        ...
        IERC20(wantAddress).safeTransfer(hecoFarmAddress, _wantAmt);
